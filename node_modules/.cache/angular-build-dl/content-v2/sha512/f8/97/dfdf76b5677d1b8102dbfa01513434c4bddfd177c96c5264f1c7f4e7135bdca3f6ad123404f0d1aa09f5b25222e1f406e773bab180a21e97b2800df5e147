(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddDataComponent = /** @class */ (function () {
                function AddDataComponent(tableList, route) {
                    var _this = this;
                    //this.tables = tableList.tables;
                    this.tableList = tableList;
                    this.route = route;
                    this.route.params.subscribe(function (param) { return _this.tablename = param.tname; });
                    this.tableList.getVideos('/api/table/' + this.tablename).subscribe(function (respVideo) { console.log(respVideo); _this.columnName = Object.keys(respVideo[0]); });
                }
                AddDataComponent.prototype.ngOnInit = function () {
                };
                AddDataComponent.prototype.saveData = function (form) {
                    var _this = this;
                    this.formValues = form;
                    console.log(this.formValues);
                    this.tableList.addTableRecord(this.formValues, '/api/table/' + this.tablename + '/' + 'AddData').subscribe(function (res) {
                        console.log(res._id);
                        console.log(_this.formValues);
                        _this.isAdded = res._id;
                    }, function (retVideo) {
                        _this.columnValues = retVideo;
                        console.log(retVideo);
                        _this.test = Object.keys(_this.columnValues[0]);
                        _this.testValues = Object.values(_this.columnValues[0]);
                    });
                };
                AddDataComponent.prototype.addSwitch = function () {
                    this.isAdded = null;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _table_list_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../table-list.service */ "./src/app/table-list.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var DbtableComponent = /** @class */ (function () {
                function DbtableComponent(tableList, route) {
                    var _this = this;
                    //this.tables = tableList.tables;
                    this.tableList = tableList;
                    this.route = route;
                    this.tables = [];
                    this.route.params.subscribe(function (param) { return _this.tablename = param.tname; });
                    this.tableList.getVideos('/api/table/' + this.tablename).subscribe(function (respVideo) { console.log(respVideo); _this.columnName = Object.keys(respVideo[0]); _this.tables = respVideo; });
                }
                DbtableComponent.prototype.ngOnInit = function () {
                };
                DbtableComponent.prototype.deleteData = function (url) {
                    console.log("delete Data" + url);
                    this.tableList.deleteTableRecord(url).subscribe(function (respVideo) { console.log(respVideo); window.location.reload(); });
                };
                return DbtableComponent;
            }());
            DbtableComponent.ctorParameters = function () { return [
                { type: _table_list_service__WEBPACK_IMPORTED_MODULE_2__["TableListService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var DbtableslistComponent = /** @class */ (function () {
                function DbtableslistComponent() {
                    this.tableList = ['tableA', 'tableB', 'tableC', 'tableD', 'tableE', 'tableA', 'tableB', 'tableC', 'tableD', 'tableE', 'tableA', 'tableB', 'tableC', 'tableD', 'tableE'];
                }
                DbtableslistComponent.prototype.ngOnInit = function () {
                };
                return DbtableslistComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableListService = /** @class */ (function () {
                ...
                TableListService.prototype.getVideos = function (url) {
                    return this._http.get(url);
                };
                TableListService.prototype.getTableRecord = function (url) {
                    return this._http.get(url);
                };
                TableListService.prototype.deleteTableRecord = function (url) {
                    return this._http.delete(url);
                };
                TableListService.prototype.updateTableRecord = function (record, url) {
                    console.log(JSON.stringify(record));
                    return this._http.put(url, JSON.stringify(record), this.httpOptions);
                };
                TableListService.prototype.addTableRecord = function (record, url) {
                    console.log(JSON.stringify(record));
                    return this._http.post(url, JSON.stringify(record), this.httpOptions);
                };
                return TableListService;
            }());
            TableListService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _table_list_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../table-list.service */ "./src/app/table-list.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var UpdateDataComponent = /** @class */ (function () {
                function UpdateDataComponent(tableList, route) {
                    this.tableList = tableList;
                    this.route = route;
                }
                UpdateDataComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.params.subscribe(function (param) { _this.key = param.id; _this.tablename = param.tname; });
                    ...
                    this.tableList.getTableRecord('/api/table/' + this.tablename + '/' + this.key).subscribe(function (respVideo) {
                        console.log(respVideo);
                        _this.columnValues = respVideo;
                        _this.test = Object.keys(_this.columnValues[0]);
                        _this.testValues = Object.values(_this.columnValues[0]);
                    });
                };
                UpdateDataComponent.prototype.updateData = function (form) {
                    var _this = this;
                    this.formValues = form;
                    console.log(this.formValues);
                    this.tableList.updateTableRecord(this.formValues, '/api/table/' + this.tablename + '/' + this.key).subscribe(function (retVideo) {
                        _this.isUpdated = retVideo.nModified;
            ...
            UpdateDataComponent.ctorParameters = function () { return [
                { type: _table_list_service__WEBPACK_IMPORTED_MODULE_2__["TableListService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
            ]; };
